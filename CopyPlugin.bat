...
echo off
rem This will copy over the compiled plugin and its dependencies to the central plugins folder
...
echo CONFIG=%CONFIG%
set EXEOUTPUT=%SOLNFOLDER%\PluginsDeliveryFolder\out
set destination="%EXEOUTPUT%\%pluginname%"
